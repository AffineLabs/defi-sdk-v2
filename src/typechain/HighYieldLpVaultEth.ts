...
export interface HighYieldLpVaultEthInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "setDebtEscrow",
    values: [string],
  ): string;
...
export type DebtRegistrationEventFilter =
  TypedEventFilter<DebtRegistrationEvent>;
...
export interface HighYieldLpVaultEth extends BaseContract {
  ...
  filters: {
    ...
    "DebtRegistration(address,address,address,uint256)"(
      caller?: null,
      receiver?: null,
      owner?: string | null,
      shares?: null,
    ): DebtRegistrationEventFilter;
    DebtRegistration(
      caller?: null,
      receiver?: null,
      owner?: string | null,
    ...
    "StrategyWithdrawal(uint256,uint256)"(
