...
export interface AffinePassBridgeInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "affinePass",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "bridgePass",
    values: [BigNumberish, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "ccipFee",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "chainReceiver",
    values: [BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "whitelistDestinationChain",
  ...
  encodeFunctionData(
    functionFragment: "whitelistedDestinationChains",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface AffinePassBridge extends BaseContract {
  ...
  filters: {
    ...
    "BridgeReceipt(bytes32,uint64,address,uint256)"(
      messageId?: BytesLike | null,
      sourceChainSelector?: BigNumberish | null,
      receiver?: null,
      id?: null
    ): BridgeReceiptEventFilter;
    BridgeReceipt(
      messageId?: BytesLike | null,
      sourceChainSelector?: BigNumberish | null,
      receiver?: null,
    ...
    "BridgeRequest(bytes32,uint64,address,uint256)"(
      messageId?: BytesLike | null,
      destinationChainSelector?: BigNumberish | null,
      sender?: null,
      id?: null
