...
export class L2USDEarnVault__factory {
  static readonly abi = _abi;
  static createInterface(): L2USDEarnVaultInterface {
    return new utils.Interface(_abi) as L2USDEarnVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): L2USDEarnVault {
    return new Contract(address, _abi, signerOrProvider) as L2USDEarnVault;
  }
}
