...
import type {
  DeltaNeutralLpV3,
  DeltaNeutralLpV3Interface,
} from "../DeltaNeutralLpV3";
...
export class DeltaNeutralLpV3__factory {
  ...
  static createInterface(): DeltaNeutralLpV3Interface {
    return new utils.Interface(_abi) as DeltaNeutralLpV3Interface;
  }
  ...
  static connect(
    ...
    return new Contract(address, _abi, signerOrProvider) as DeltaNeutralLpV3;
  }
}
