...
import type {
  StaderLevMaticStrategy,
  StaderLevMaticStrategyInterface,
} from "../StaderLevMaticStrategy";
...
export class StaderLevMaticStrategy__factory {
  static readonly abi = _abi;
  static createInterface(): StaderLevMaticStrategyInterface {
    return new utils.Interface(_abi) as StaderLevMaticStrategyInterface;
  }
  static connect(
    address: string,
