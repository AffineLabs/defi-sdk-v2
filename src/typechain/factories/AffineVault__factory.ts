...
export class AffineVault__factory {
  static readonly abi = _abi;

  static createInterface(): AffineVaultInterface {
    return new utils.Interface(_abi) as AffineVaultInterface;
  }
  ...
  static connect(
    ...
    return new Contract(address, _abi, signerOrProvider) as AffineVault;
  }
}
