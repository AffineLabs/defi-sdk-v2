...
import type {
  SSVDeltaNeutralLp,
  SSVDeltaNeutralLpInterface,
  LendingInfoStruct,
  LpInfoStruct,
} from "../SSVDeltaNeutralLp";
...
export class SSVDeltaNeutralLp__factory {
  static readonly abi = _abi;
  static createInterface(): SSVDeltaNeutralLpInterface {
    return new utils.Interface(_abi) as SSVDeltaNeutralLpInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SSVDeltaNeutralLp {
    return new Contract(address, _abi, signerOrProvider) as SSVDeltaNeutralLp;
  }
}
