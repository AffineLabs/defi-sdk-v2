...
import type {
  DegenVaultV2Eth,
  DegenVaultV2EthInterface,
} from "../DegenVaultV2Eth";
...
export class DegenVaultV2Eth__factory {
  static readonly abi = _abi;
  static createInterface(): DegenVaultV2EthInterface {
    return new utils.Interface(_abi) as DegenVaultV2EthInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DegenVaultV2Eth {
    return new Contract(address, _abi, signerOrProvider) as DegenVaultV2Eth;
  }
}
