...
export class XUltraLRT__factory {
  static readonly abi = _abi;
  static createInterface(): XUltraLRTInterface {
    return new utils.Interface(_abi) as XUltraLRTInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): XUltraLRT {
    return new Contract(address, _abi, signerOrProvider) as XUltraLRT;
  }
}
