...
import {AllowedChainId, NetworkParams, WithdrawSlippageByProduct } from "./sdk-v1-types";
...
export const ALLOWED_CHAIN_IDS: AllowedChainId[] = NETWORK_TYPE === "mainnet" ? [1, 137] : [5, 80001, 17000];
