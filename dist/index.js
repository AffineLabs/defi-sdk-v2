...
const eigenlayerStrategy_json_1 = __importDefault(
  require("./abis/eigenlayerStrategy.json"),
);
const ultraEth_json_1 = __importDefault(require("./abis/ultraEth.json"));
const withdrawalEscrow_json_1 = __importDefault(
  require("./abis/withdrawalEscrow.json"),
);
const delegationManager_json_1 = __importDefault(
  require("./abis/delegationManager.json"),
);
class AffineRestakingSDK {
  ...
  getUltraEthBalance() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const erc20Contract = new ethers_1.ethers.Contract(
        constants_1.UltraLRTAddress,
  ...
  migratableAssets(address) {
    return __awaiter(this, void 0, void 0, function* () {
      const eigenStETH = new ethers_1.ethers.Contract(
        constants_1.EigenStETHStrategy,
        eigenlayerStrategy_json_1.default,
        this.signer,
      );
  ...
  queueMigrationWithdrawal(address, assets) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const eigenDelegator = new ethers_1.ethers.Contract(
        constants_1.EigenDelegatorAddress,
        delegationManager_json_1.default,
        this.signer,
      );
      ...
      const queuedWithdrawalParams = [
        [
          [
            [constants_1.EigenStETHStrategy],
            [ethers_1.ethers.BigNumber.from(shares)],
            address,
          ],
        ],
      ];
  ...
  completeMigrationWithdrawal(address, delegator, nonce, blockNumber, shares) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const tx = yield eigenDelegator.completeWithdrawals(
        withdrawalInfos,
        assetsArray,
        uint256Array,
        boolArray,
  ...
  canWithdraw(amount) {
    return __awaiter(this, void 0, void 0, function* () {
      const asset = new ethers_1.ethers.Contract(
        constants_1.StETHAddress,
        erc20_json_1.default,
        this.signer,
      );
      const lrtVault = new ethers_1.ethers.Contract(
        constants_1.UltraLRTAddress,
        ultraEth_json_1.default,
        this.signer,
      );
      const value = yield lrtVault.canWithdraw(
        this._addDecimals(amount.toString(), yield asset.decimals()),
      );
      return value;
    });
  }
  ...
  deposit(amount) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const tx = yield lrtVault.deposit(
        assetUnits,
  ...
  withdrawableAssets(address) {
    return __awaiter(this, void 0, void 0, function* () {
      const vault = new ethers_1.ethers.Contract(
        constants_1.UltraLRTAddress,
        ultraEth_json_1.default,
        this.signer,
      );
      ...
      const withdrawalEscrowV2 = new ethers_1.ethers.Contract(
        constants_1.EscrowAddress,
        withdrawalEscrow_json_1.default,
        this.signer,
      );
      const vaultDecimals = yield vault.decimals();
      const assetDecimals = yield asset.decimals();
      const resolvingEpoch =
        (yield withdrawalEscrowV2.resolvingEpoch()).toNumber();
      const currentEpoch = (yield withdrawalEscrowV2.currentEpoch()).toNumber();
      let totalAmount = 0;
      const epochData = [];
      for (let i = 0; i <= currentEpoch; i++) {
        const shares = yield withdrawalEscrowV2.userDebtShare(
  ...
  isApproved(contractAddress, spenderAddress, amount) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const units = this._addDecimals(
        amount.toString(),
        yield erc20Contract.decimals(),
      );
      const allowance = yield erc20Contract.allowance(
        yield this.signer.getAddress(),
        spenderAddress,
      );
