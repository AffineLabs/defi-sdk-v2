...
export interface ForwarderInterface extends utils.Interface {
    functions: {
        ...
        "executeBatch((address,address,uint256,uint256,uint256,bytes)[],bytes)": FunctionFragment;
        "getNonce(address)": FunctionFragment;
        "verify((address,address,uint256,uint256,uint256,bytes),bytes)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "execute" | "executeBatch" | "getNonce" | "verify"): FunctionFragment;
    encodeFunctionData(functionFragment: "execute", values: [MinimalForwarder.ForwardRequestStruct, BytesLike]): string;
    encodeFunctionData(functionFragment: "executeBatch", values: [MinimalForwarder.ForwardRequestStruct[], BytesLike]): string;
...
export interface Forwarder extends BaseContract {
    ...
    functions: {
        ...
        executeBatch(requests: MinimalForwarder.ForwardRequestStruct[], signatures: BytesLike, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        executeBatch(requests: MinimalForwarder.ForwardRequestStruct[], signatures: BytesLike, overrides?: CallOverrides): Promise<void>;
        getNonce(from: string, overrides?: CallOverrides): Promise<BigNumber>;
        verify(req: MinimalForwarder.ForwardRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<boolean>;
    };
    filters: {};
