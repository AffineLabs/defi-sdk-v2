...
export interface AffineGenesisInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "mintDev", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mintWhitelist", values: [BigNumberish, BytesLike[]]): string;
...
export interface AffineGenesis extends BaseContract {
    ...
    functions: {
        ...
        mintDev(amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        mintWhitelist(quantity: BigNumberish, proof: BytesLike[], overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mintWhitelist(quantity: BigNumberish, proof: BytesLike[], overrides?: CallOverrides): Promise<void>;
        name(overrides?: CallOverrides): Promise<string>;
        owner(overrides?: CallOverrides): Promise<string>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
