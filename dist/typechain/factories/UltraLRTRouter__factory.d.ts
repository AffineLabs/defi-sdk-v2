...
import type { UltraLRTRouter, UltraLRTRouterInterface } from "../UltraLRTRouter";
export declare class UltraLRTRouter__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): UltraLRTRouter;
}
