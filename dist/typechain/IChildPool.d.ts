...
export interface IChildPoolInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "claimMaticXSwap", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "claimedMatic", values?: undefined): string;
    encodeFunctionData(functionFragment: "convertMaticToMaticX", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "convertMaticXToMatic", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "getAmountAfterInstantWithdrawalFees", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "getUserMaticXSwapRequests", values: [string]): string;
    ...
    encodeFunctionData(functionFragment: "provideInstantPoolMaticX", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "requestMaticXSwap", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setFxStateChildTunnel", values: [string]): string;
    encodeFunctionData(functionFragment: "setInstantPoolOwner", values: [string]): string;
    encodeFunctionData(functionFragment: "setInstantWithdrawalFeeBps", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "setMaticXSwapLockPeriod", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "swapMaticXForMaticViaInstantPool", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "togglePause", values?: undefined): string;
    encodeFunctionData(functionFragment: "treasury", values?: undefined): string;
    encodeFunctionData(functionFragment: "version", values?: undefined): string;
    encodeFunctionData(functionFragment: "withdrawInstantPoolMatic", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "withdrawInstantPoolMaticX", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "withdrawInstantWithdrawalFees", values: [BigNumberish]): string;
...
export interface IChildPool extends BaseContract {
    ...
    functions: {
        claimMaticXSwap(_idx: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        claimedMatic(overrides?: CallOverrides): Promise<[BigNumber]>;
        convertMaticToMaticX(_balance: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber]>;
        convertMaticXToMatic(_balance: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber]>;
        getAmountAfterInstantWithdrawalFees(_amount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        ...
        getUserMaticXSwapRequests(_address: string, overrides?: CallOverrides): Promise<[IChildPool.MaticXSwapRequestStructOutput[]]>;
        ...
        provideInstantPoolMaticX(_amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        requestMaticXSwap(_amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setFxStateChildTunnel(_address: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setInstantPoolOwner(_address: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setInstantWithdrawalFeeBps(_feeBps: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setMaticXSwapLockPeriod(_hours: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setTreasury(_address: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setTrustedForwarder(_address: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        setVersion(_version: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        swapMaticForMaticXViaInstantPool(overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        swapMaticXForMaticViaInstantPool(_amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        withdrawInstantPoolMatic(_amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdrawInstantPoolMaticX(_amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        withdrawInstantWithdrawalFees(_amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    claimMaticXSwap(_idx: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        claimMaticXSwap(_idx: BigNumberish, overrides?: CallOverrides): Promise<void>;
        claimedMatic(overrides?: CallOverrides): Promise<BigNumber>;
        convertMaticToMaticX(_balance: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber]>;
        convertMaticXToMatic(_balance: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber, BigNumber]>;
        getAmountAfterInstantWithdrawalFees(_amount: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
        ...
        provideInstantPoolMaticX(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        requestMaticXSwap(_amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        setFxStateChildTunnel(_address: string, overrides?: CallOverrides): Promise<void>;
        setInstantPoolOwner(_address: string, overrides?: CallOverrides): Promise<void>;
        setInstantWithdrawalFeeBps(_feeBps: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setMaticXSwapLockPeriod(_hours: BigNumberish, overrides?: CallOverrides): Promise<void>;
        setTreasury(_address: string, overrides?: CallOverrides): Promise<void>;
        setTrustedForwarder(_address: string, overrides?: CallOverrides): Promise<void>;
        ...
        swapMaticXForMaticViaInstantPool(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        togglePause(overrides?: CallOverrides): Promise<void>;
        treasury(overrides?: CallOverrides): Promise<string>;
        version(overrides?: CallOverrides): Promise<string>;
        withdrawInstantPoolMatic(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        withdrawInstantPoolMaticX(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        withdrawInstantWithdrawalFees(_amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "ClaimMaticXSwap(address,uint256,uint256)"(_from?: string | null, _idx?: BigNumberish | null, _amountClaimed?: null): ClaimMaticXSwapEventFilter;
        ClaimMaticXSwap(_from?: string | null, _idx?: BigNumberish | null, _amountClaimed?: null): ClaimMaticXSwapEventFilter;
        ...
        "RequestMaticXSwap(address,uint256,uint256,uint256)"(_from?: string | null, _amountMaticX?: null, _amountMatic?: null, userSwapRequestsIndex?: null): RequestMaticXSwapEventFilter;
        RequestMaticXSwap(_from?: string | null, _amountMaticX?: null, _amountMatic?: null, userSwapRequestsIndex?: null): RequestMaticXSwapEventFilter;
    ...
    estimateGas: {
        ...
        claimedMatic(overrides?: CallOverrides): Promise<BigNumber>;
        convertMaticToMaticX(_balance: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        convertMaticXToMatic(_balance: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getAmountAfterInstantWithdrawalFees(_amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        getContracts(overrides?: CallOverrides): Promise<BigNumber>;
        getMaticXSwapLockPeriod(overrides?: CallOverrides): Promise<BigNumber>;
        getUserMaticXSwapRequests(_address: string, overrides?: CallOverrides): Promise<BigNumber>;
        instantPoolMatic(overrides?: CallOverrides): Promise<BigNumber>;
        instantPoolMaticX(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        convertMaticToMaticX(_balance: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        convertMaticXToMatic(_balance: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getAmountAfterInstantWithdrawalFees(_amount: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getUserMaticXSwapRequests(_address: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
