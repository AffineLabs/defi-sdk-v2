...
export interface LockedWithdrawalEscrowInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "requestTimes", values: [string]): string;
    encodeFunctionData(functionFragment: "resolveDebtShares", values: [BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "withdrawableAmount", values: [string]): string;
...
export interface LockedWithdrawalEscrow extends BaseContract {
    ...
    functions: {
        ...
        registerWithdrawalRequest(user: string, debtShares: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        requestTimes(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
        resolveDebtShares(resolvedAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        withdrawableAmount(user: string, overrides?: CallOverrides): Promise<[BigNumber]>;
    };
    DOMAIN_SEPARATOR(overrides?: CallOverrides): Promise<string>;
    allowance(arg0: string, arg1: string, overrides?: CallOverrides): Promise<BigNumber>;
    approve(spender: string, amount: BigNumberish, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        registerWithdrawalRequest(user: string, debtShares: BigNumberish, overrides?: CallOverrides): Promise<void>;
        requestTimes(arg0: string, overrides?: CallOverrides): Promise<BigNumber>;
        resolveDebtShares(resolvedAmount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        sla(overrides?: CallOverrides): Promise<BigNumber>;
        symbol(overrides?: CallOverrides): Promise<string>;
        totalSupply(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        requestTimes(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        resolveDebtShares(resolvedAmount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        withdrawableAmount(user: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
