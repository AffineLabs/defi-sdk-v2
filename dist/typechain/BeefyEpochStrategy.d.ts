...
export interface BeefyEpochStrategyInterface extends utils.Interface {
    functions: {
...
export interface BeefyEpochStrategy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BeefyEpochStrategyInterface;
