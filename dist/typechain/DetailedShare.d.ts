...
export interface DetailedShareInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "detailedPrice" | "detailedTVL" | "detailedTotalSupply"): FunctionFragment;
...
export interface DetailedShare extends BaseContract {
    ...
    functions: {
        detailedPrice(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        detailedTVL(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        detailedTotalSupply(overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    detailedPrice(overrides?: Overrides & {
