...
export interface L1WormholeRouterInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "receiveFundRequest", values: [BytesLike]): string;
    encodeFunctionData(functionFragment: "receiveFunds", values: [BytesLike, BytesLike]): string;
    encodeFunctionData(functionFragment: "reportFundTransfer", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "reportTVL", values: [BigNumberish, boolean]): string;
...
export interface L1WormholeRouter extends BaseContract {
    ...
    functions: {
        ...
        receiveFundRequest(message: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        receiveFunds(message: BytesLike, data: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        reportFundTransfer(amount: BigNumberish, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        reportTVL(tvl: BigNumberish, received: boolean, overrides?: PayableOverrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        nextValidNonce(overrides?: CallOverrides): Promise<BigNumber>;
        otherLayerWormholeId(overrides?: CallOverrides): Promise<number>;
        receiveFundRequest(message: BytesLike, overrides?: CallOverrides): Promise<void>;
        receiveFunds(message: BytesLike, data: BytesLike, overrides?: CallOverrides): Promise<void>;
        reportFundTransfer(amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        reportTVL(tvl: BigNumberish, received: boolean, overrides?: CallOverrides): Promise<void>;
