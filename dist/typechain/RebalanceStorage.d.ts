...
export interface RebalanceStorageInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setRebalanceModule", values: [string]): string;
...
export interface RebalanceStorage extends BaseContract {
    ...
    functions: {
        ...
        setRebalanceModule(_rebalanceModule: string, overrides?: Overrides & {
            from?: string;
    ...
    callStatic: {
        governance(overrides?: CallOverrides): Promise<string>;
        rebalanceModule(overrides?: CallOverrides): Promise<string>;
        setRebalanceModule(_rebalanceModule: string, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
