...
export interface StrategyVaultV2Interface extends utils.Interface {
    functions: {
...
export interface StrategyVaultV2 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: StrategyVaultV2Interface;
